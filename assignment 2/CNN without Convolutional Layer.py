...
#Creating a function for our neural network
def NN():
...
#Saving the model
model.save('CNN_digit_NoLyr.hdf5')
...
def crossVal(pred, true):
    ...
    for i in range(folds):#split X_train and X_test datasets
        ...
        y_val.extend(y_test)
    #Apply the accuracy function to find the error rate
